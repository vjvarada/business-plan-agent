...
def create_business_plan_local(company_name, industry, description):
    ...
    doc.add_paragraph("")
    doc.add_paragraph(
        "This business plan outlines our market opportunity, competitive positioning, and financial projections for the next 5-10 years."
    )
    ...
    doc.add_paragraph(
        "See accompanying financial model for detailed 10-year projections."
    )
    ...
    print(
        f"   Sections: Executive Summary, Market Analysis, SWOT, Business Model, Financial Projections"
    )
    print(f"\nNext steps:")
