...
| 104 | AMC COGS % | 35.00% | % | Gartner IT Services | Parts ~15% + technician time ~20% |
...
| Row | Metric | Value | Unit | Source | Notes |
|-----|--------|-------|------|--------|-------|
| 118 | 3D Printer Attach Rate | 20.00% | % | Gartner Tech Adoption 2024 | Hardware cross-sell: 15-25% typical for B2B SaaS |
| 119 | Consumables/Printer/Year | 40 | units | Stratasys Usage Data | Industrial printer: 3-4 spools/month avg |
| 120 | AMC Attach Rate | 35.00% | % | Gartner IT Services | Service attach: 30-40% for equipment sales |
| 121 | Managed Services Rate | 5.00% | % | Deloitte Enterprise Services | Enterprise tier: 3-7% of B2B customer base |
